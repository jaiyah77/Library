...
$('.flick-sample-in').horizontalBox({
	item: '.flick-panel',
	ui: 'flick',
	indicator: true
});

$('.scroll-sample-in').horizontalBox({
	item: 'ul .item',
	ui: 'scroll',
	snap: true
});

$('.card-sample-in').horizontalBox({
	item: '.flick-panel',
	'ui': 'card',
	'indicator': true
});

$('.scroll-sample-01').horizontalBox({
	item: 'ul li'
});

$('.scroll-sample-02').horizontalBox({
	item: 'ul li'
});

$('.scroll-sample-03').horizontalBox({
	item: 'ul .item',
	snap: true
});

$('.scroll-sample-04').horizontalBox({
	item: 'ul .item',
	snap: true,
	momentum: false
});

$('.scroll-sample-05').horizontalBox({
	item: 'ul .item',
	snap: true,
	momentum: false
});

$('.card-sample-01').horizontalBox({
	item: '.flick-panel',
	'ui': 'card',
	'indicator': true
});

$('.card-sample-02').horizontalBox({
	item: '.flick-panel',
	'ui': 'card',
	"_autoPlay": true,
	'indicator': true,
	'indicatorType': 'number',
	'playSpeed': 2000 //defalt 3000
});

$('.flick-sample-01').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick'
});

$('.flick-sample-02').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick',
	'indicator': true
});

$('.flick-sample-03').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick',
	"_autoPlay": true,
	'indicator': true,
...
$('.flick-sample-06').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick',
	'indicator': true,
	'control': true,
	'callback': function(){
		var data = $('.flick-sample-06').data();
		console.log('This is flick count number:',
				data.horizontalBox.detect.flickCount);
	}
});

$('.flick-sample-07').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick',
	'indicator': true,
	'indicatorType': 'number',
...
$('.flick-sample-10').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick',
	'indicator': true
});

$('.flick-sample-09').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick',
	'indicator': true
});

$('.flick-sample-11').horizontalBox({
	item: '.flick-panel',
	'ui': 'flick',
	'indicator': true
});
